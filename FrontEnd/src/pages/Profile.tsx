...
const Profile = () => {
  return (
    <>
      ...
      <div className="overflow-hidden rounded-xl border-2 border-stroke bg-white shadow-lg dark:border-strokedark dark:bg-boxdark">
        {/* Cover Image Section */}
        <div className="relative z-20 h-48 md:h-80">
          <img
            src={CoverOne}
            alt="profile cover"
          ...
          <div className="absolute bottom-4 right-4 z-10">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary py-2 px-4 text-sm font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="relative z-30 mx-auto -mt-22 h-30 w-30 max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:w-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white transition duration-300 ease-in-out hover:bg-opacity-80 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          {/* User Info */}
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-bold text-black dark:text-white">
              Danish Heilium
            </h3>
            <p className="font-medium text-gray-5">UI/UX Designer</p>

            {/* Stats */}
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-2xl border-2 border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="text-xl font-bold text-black dark:text-white">
                  259
                </span>
                <span className="text-sm text-gray-5">Posts</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="text-xl font-bold text-black dark:text-white">
                  129K
                </span>
                <span className="text-sm text-gray-5">Followers</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="text-xl font-bold text-black dark:text-white">
                  2K
                </span>
                <span className="text-sm text-gray-5">Following</span>
              </div>
            </div>

            {/* About Section */}
            <div className="mx-auto max-w-180 rounded-2xl bg-gray-2 p-8 dark:bg-meta-4">
              <h4 className="mb-4 text-xl font-bold text-black dark:text-white">
                About Me
              </h4>
              <p className="text-gray-6 dark:text-gray-4 leading-relaxed">
            ...
            <div className="mt-6.5 mb-8">
              ...
              <div className="flex items-center justify-center gap-5">
                <Link
                  to="#"
                  className="hover:text-primary transition duration-300 ease-in-out p-2 hover:bg-gray-2 rounded-lg"
