...
{
    public class EditarJobProgramadoValidator : AbstractValidator<EditarJobProgramadoCommand>
    {
        public EditarJobProgramadoValidator()
        {
            ...
            RuleFor(x => x.MetodoHttp)
                .IsInEnum()
                .WithMessage("El método HTTP debe ser válido");
        ...
        private bool BeValidCrontab(string crontab)
        {
    ...
    public class ParametroDtoValidator : AbstractValidator<ServicioJobs.Aplicacion.Feature.Parametros.Dto.ParametroDto>
    {
        public ParametroDtoValidator()
        {
            ...
            RuleFor(x => x.Tipo)
                .IsInEnum()
                .WithMessage("El tipo de parámetro debe ser válido");
        }
    }
} 